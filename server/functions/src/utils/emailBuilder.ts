// functions/src/utils/emailBuilder.ts
...
/**
 * Dispatches an HTML or plain text email via Mailgun API v3.
 */
export const sendMailgunEmail = async ({
  ...
  // Safely append file buffers to form data
