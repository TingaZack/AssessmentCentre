...
const getMailgunConfig = () => {
  ...
  try {
    ...
    logger.debug("Mailgun secret unavailable; falling back to environment", error);
  }
...
${dividerPage("9", "Annexures", "Identity documents, supporting compliance files, and evidence submissions uploaded by the learner — appended on the following pages.")}
            ...
            try {
              ...
              try {
                ...
                try {
                  ...
                  console.warn(
                    `Annexure is not a supported PDF/PNG/JPG: ${evidence.url}`,
                    imageError,
                  );
                }
              }
      ...
      try {
        ...
        console.warn(
          `Could not clear previous PoE exports for ${learnerId}`,
          cleanupError,
        );
      }
