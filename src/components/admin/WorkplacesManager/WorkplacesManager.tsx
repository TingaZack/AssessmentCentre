    ...
    const handleSaveMentor = async (e: React.FormEvent) => {
        ...
        try {
            if (editingMentor) {
                ...
                // 🚀 IF NEW: Route it through your global addStaff action to trigger the Cloud Function!
                await addStaff({
...
//         contactEmail: '',
//         contactPhone: '',
//         lat: null as number | null, // 🚀 Added lat
//         lng: null as number | null  // 🚀 Added lng
//     });
...
//                 contactEmail: employer.contactEmail || '',
//                 contactPhone: employer.contactPhone || '',
//                 lat: employer.lat || null, // 🚀 Load existing coords
//                 lng: employer.lng || null  // 🚀 Load existing coords
//             });
//         } else {
//             setEditingEmployer(null);
//             setEmpFormData({
...
//     // 🚀 Google Places Autocomplete Handler (Now captures Lat/Lng)
//     const handlePlaceSelected = (place: any) => {
//         const addressComponents = place.address_components;
//         const getComp = (type: string) => addressComponents?.find((c: any) => c.types.includes(type))?.long_name || "";
...
//             ...prev,
//             physicalAddress: formattedAddress,
//             lat: newLat, // 🚀 Store lat
//             lng: newLng  // 🚀 Store lng
//         }));
//     };
...
//         setSaving(true);
//         try {
//             const mentorRef = editingMentor ? doc(db, 'users', editingMentor.id) : doc(collection(db, 'users'));
//             const payload = {
//                 id: mentorRef.id,
//                 fullName: mentorFormData.fullName,
//                 email: mentorFormData.email,
...
//                 status: 'active',
//                 updatedAt: new Date().toISOString(),
//                 ...(editingMentor ? {} : { createdAt: new Date().toISOString() })
//             };

//             await setDoc(mentorRef, payload, { merge: true });
//             toast.success(`Mentor ${editingMentor ? 'updated' : 'added'} successfully!`);
