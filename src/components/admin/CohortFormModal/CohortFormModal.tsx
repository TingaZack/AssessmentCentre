...
export const CohortFormModal: React.FC<Props> = ({ cohort, onClose, onSave }) => {
    // 🚀 NEW: Pulled `settings` from the store to get the campuses
    ...
    // 🚀 NEW: Added campusId to form data
    ...
    useEffect(() => {
        if (cohort) {
            ...
            // 🚀 SMART UX: Auto-select the default campus for new cohorts
