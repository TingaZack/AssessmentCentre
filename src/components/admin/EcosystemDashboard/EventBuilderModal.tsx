...
export const EventBuilderModal: React.FC<EventBuilderModalProps> = ({
    ...
    // 🚀 CRITICAL: DATA INTEGRITY GEOMETRY
...
// import {
//     X, Save, Loader2, AlertCircle, Calendar,
//     Settings, ListPlus, Plus, Trash2, Globe, Lock, Tag, Wifi, Target
// } from "lucide-react";
// import Autocomplete from "react-google-autocomplete";
// import { useToast } from "../../../components/common/Toast/Toast";
// import { useStore } from "../../../store/useStore";
...
//             maxCapacity,
//             eventType: finalEventType,
//             linkedTargets: linkedTargets, // 🚀 Include linked targets in payload
...
//                                 {/* 🚀 NEW: MULTI-SELECT KPI TARGET LINKAGE BLOCK */}
//                                 <div>
//                                     <div className="lfm-section-hdr"><Target size={13} /> KPI Target Linkage</div>
