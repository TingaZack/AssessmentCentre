...
// Removed 'limit' from imports since we want all attendees
import { doc, onSnapshot, query, collection, where, orderBy, getDoc } from 'firebase/firestore';
import { QRCodeSVG } from 'qrcode.react';
import { db } from '../../../lib/firebase';
import { Loader2, ArrowLeft, Printer, Clock, Lock } from 'lucide-react';
import moment from 'moment';
import type { EcosystemEvent } from '../../../types/ecosystem.types';

import mLogo from '../../../assets/logo/mlab_logo_white.png';
import mLogoDark from '../../../assets/logo/mlab_logo.png';
...
export const EventKioskPage: React.FC = () => {
    ...
    if (loading) {
        return (
            <div style={{ minHeight: '100vh', position: 'absolute', top: 0, bottom: 0, left: 0, right: 0, background: MIDNIGHT, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
    ...
    return (
        <>
            ...
            {/* THE PRINT-ONLY VIEW (Hidden on screen, shown on paper) */}
            {isActive && (
