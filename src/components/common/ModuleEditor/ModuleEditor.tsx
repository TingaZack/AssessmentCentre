...
// 🚀 SMART NORMALIZER: Safely handles weird spreadsheet uploads
const normalizeStatus = (status?: string) => {
    if (!status) return "Not Started"; // Blanks become Not Started
    ...
    // Catch-all for "On-Going", "Pending", "Busy", or any unrecognized text
    return "In Progress";
};
