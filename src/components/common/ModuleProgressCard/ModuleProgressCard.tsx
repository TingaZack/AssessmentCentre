...
export type ModuleCardType =
    ...
    | 'Global Retention' | 'Pipeline Activation' | 'Active Attendance' | 'Total Training Time'
...
export const ModuleProgressCard: React.FC<ModuleProgressCardProps> = ({ type, data, onClick }) => {
    ...
    const isKPI = !['Knowledge', 'Practical', 'Workplace'].includes(type);
    ...
    const config: Record<string, any> = {
        ...
        'At-Risk Analytics': {
            color: '#ef4444', bg: '#fef2f2', title: 'At-Risk Analytics', unit: 'learners', label: 'Quality KPI', bar1: 'At-Risk', bar2: 'On-Track',
            description: 'Learners with NYC statuses or overdue completion dates.',
