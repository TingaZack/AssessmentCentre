...
//     provinces: string[];
//     cities: string[];
// }> = ({ selected, onSelect, provinces, cities }) => {
//     const [isOpen, setIsOpen] = useState(false);
//     const [search, setSearch] = useState('');
//     const ref = useRef<HTMLDivElement>(null);
...
//                     ...profile,
//                     ...enrollment,
//                     // Prevent enrollment data from wiping out profile demographics
//                     demographics: { ...profile.demographics, ...(enrollment.demographics || {}) },
//                     enrollmentId: enrollment.id,
//                     learnerId: profile.id,
//                     status: enrollment.status || profile.status
...
//         enrolledLearners.forEach(l => {
//             locations.add(getLocationString(l));
//         });
...
//                 provinces.add(provInfo.name);
//             } else if (provStr) {
//                 // If it's a custom string not in our map, just use the raw string
//                 provinces.add(provStr);
//             }
...
// //     Users, Calendar, ChevronLeft, Mail, Phone, DownloadCloud,
// //     FolderOpen, UserCheck, Clock, CheckCircle2, AlertCircle, XCircle,
// //     UploadCloud, Search, X, Info, BarChart2, Target, UserMinus, Edit2, Loader2, Video, Layers, History, ChevronDown, ChevronUp, CheckCircle, MapPin, Filter, FilterX, ChevronRight, Globe,
// //     Timer, PenTool, BookOpen, Award, ShieldCheck, User, Sparkles, Edit3, Trash2, Plus, Link as LinkIcon, Maximize, Minimize
// // } from 'lucide-react';
// // import * as XLSX from 'xlsx';
...
// //             <div className="lfm-modal" style={{ maxWidth: '1000px', height: '90vh', borderRadius: 0 }}>
...
// //                             <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', width: '80px', height: '80px', background: 'rgba(148, 199, 61, 0.1)', borderRadius: 0, marginBottom: '1.5rem' }}>
...
// //                                         <div style={{ background: '#e0f2fe', border: '1px solid #bae6fd', borderLeft: '4px solid #0ea5e9', padding: '8px 12px', borderRadius: 0, fontSize: '0.8rem', color: '#0369a1' }}>
// //                                             {!existingReport ? <strong>Automated QCTO Compliance:</strong> : <strong>Edit Mode:</strong>} Review your content below.
// //                                         </div>

// //                                         <div style={{ display: 'flex', alignItems: 'center', gap: '8px', background: 'white', border: '1px solid #cbd5e1', padding: '6px 12px', borderRadius: 0 }}>
...
// //                                         </div>
// //                                     </div>
// //                                     <button onClick={handleEnhanceText} disabled={isEnhancing} className="lfm-btn" style={{ background: '#fdf4ff', color: '#c026d3', border: '1px solid #f0abfc', borderRadius: 0, padding: '6px 12px', fontSize: '0.75rem', cursor: isEnhancing ? 'not-allowed' : 'pointer' }}>
// //                                         {isEnhancing ? <Loader2 size={14} className="lfm-spin" /> : <Sparkles size={14} />} Enhance Highlighted Text
// //                                     </button>
// //                                 </div>
// //                                 <div style={{ background: 'white', color: '#000000', border: '1px solid var(--mlab-border)', borderRadius: 0, flex: 1, display: 'flex', flexDirection: 'column' }}>
...
// //                                 <div style={{ background: '#f0fdf4', border: '1px solid #bbf7d0', padding: '1rem', borderRadius: 0, marginBottom: '1.5rem', borderLeft: '4px solid var(--mlab-green)' }}>
...
// //                                     {authorSignature ? (
// //                                         <div style={{ background: 'white', padding: '12px', borderRadius: 0, border: '1px dashed #bbf7d0', textAlign: 'center' }}>
...
// //                                         </div>
// //                                     ) : (
// //                                         <div style={{ background: 'white', padding: '12px', borderRadius: 0, border: '1px dashed #fca5a5', textAlign: 'center' }}>
...
// //                                         <div key={idx} style={{ background: '#f8fafc', border: '1px solid var(--mlab-border)', padding: '10px', borderRadius: 0 }}>
...
// //                                         </div>
// //                                     ))}
// //                                     <button onClick={() => setEvidenceItems(p => [...p, { url: '', description: '' }])} className="lfm-btn lfm-btn--ghost" style={{ justifyContent: 'center', padding: '8px', fontSize: '0.8rem', borderRadius: 0 }}><Plus size={14} /> Add Another Link</button>
// //                                 </div>
// //                             </div>
// //                         </div>
// //                     )}
...
// //                 <div className="lfm-footer" style={{ background: 'var(--mlab-bg)', borderRadius: 0 }}>
...
// //             const city = String(l.demographics?.city || (l as any).city || '').trim();
...
// //                 if (!stats.has(other)) stats.set(other, { lat: -28.4793, lng: 24.6727, count: 0, name: other });
...
// //     // This allows us to inject the map flawlessly into a solid DOM element, or directly onto the body portal
// //     const renderMapComponent = (isFullscreen: boolean) => (
// //         <div style={{ height: '100%', display: 'flex', flexDirection: 'column', backgroundColor: 'var(--mlab-white)' }}>
...
// //                                                                     {/* 🚀 EXPLICIT WITHDRAW BUTTON ADDED BACK FOR ALL ACTIVE LEARNERS */}
// //                                                                     {!isDropped && (
// //                                                                         <button
// //                                                                             onClick={() => setLearnerToDrop(learner)}
// //                                                                             title="Process Withdrawal / Dropout"
...
// //                                                                         target="_blank"
// //                                                                         rel="noopener noreferrer"
// //                                                                         onClick={(e) => e.stopPropagation()} // Prevents row click from firing
// //                                                                         style={{
// //                                                                             display: 'inline-flex', alignItems: 'center', gap: '4px',
// //                                                                             background: '#e0f2fe', color: '#0284c7', border: '1px solid #bae6fd',
// //                                                                             padding: '2px 6px', fontSize: '0.65rem', fontWeight: 800,
...
// // //     FolderOpen, UserCheck, Clock, CheckCircle2, AlertCircle, XCircle,
// // //     UploadCloud, Search, X, Info, BarChart2, Target, UserMinus, Edit2, Loader2, Video, Layers, History, ChevronDown, ChevronUp, CheckCircle, MapPin, Filter, FilterX, ChevronRight, Globe,
// // //     Timer, PenTool, BookOpen, Award, ShieldCheck, User, Sparkles, Edit3, Trash2, Plus, Link as LinkIcon
// // // } from 'lucide-react';
// // // import * as XLSX from 'xlsx';
// // // import { collection, query, where, onSnapshot, doc, updateDoc, getDocs, writeBatch, increment, getDoc } from 'firebase/firestore';
// // // import { getFunctions, httpsCallable } from 'firebase/functions';
...
// // //             const liveEnrollments = snapshot.docs.map(d => ({ id: d.id, ...d.data() }));

// // //             setEnrolledLearners(prevRoster => {
// // //                 if (prevRoster.length === 0) return prevRoster;
// // //                 return prevRoster.map(learner => {
// // //                     const match = liveEnrollments.find((e: any) =>
// // //                         e.id === learner.enrollmentId ||
// // //                         e.learnerId === learner.id ||
// // //                         e.learnerId === learner.learnerId
// // //                     );
// // //                     if (match) {
// // //                         return { ...learner, ...match, status: (match as any).status || learner.status };
// // //                     }
// // //                     return learner;
// // //                 });
// // //             });
...
// // //             // ⚡ 1. INSTANT OPTIMISTIC STATE UPDATE (Fixes the delay bug)
// // //             setEnrolledLearners(prev => prev.map(l => {
// // //                 if (l.id === learnerToDrop.id || l.learnerId === learnerToDrop.learnerId || l.enrollmentId === learnerToDrop.enrollmentId) {
// // //                     return { ...l, status: 'dropped' };
// // //                 }
// // //                 return l;
// // //             }));
...
// // //                     {cohortAnalytics && (
// // //                         <div style={{ border: '2px solid var(--mlab-blue)', borderRadius: 0, backgroundColor: 'var(--mlab-white)', marginBottom: '2rem' }}>
// // //                             <div
// // //                                 className="lfm-header"
// // //                                 onClick={() => setIsMatrixExpanded(!isMatrixExpanded)}
// // //                                 style={{ cursor: 'pointer' }}
...
// // //                             {isMatrixExpanded && (
// // //                                 <div className="lfm-body animate-fade-in" style={{ display: 'flex', flexDirection: 'column', gap: '8px', padding: '1rem 1.5rem', background: 'var(--mlab-bg)' }}>
// // //                                     {cohortAnalytics.bandResults.filter((b: any) => b.total > 0).map((band: any) => {
// // //                                         const totalPct = cohortAnalytics.baseLength > 0 ? Math.round((band.total / cohortAnalytics.baseLength) * 100) : 0;
// // //                                         const malePct = band.total > 0 ? Math.round((band.male / band.total) * 100) : 0;
// // //                                         const femalePct = band.total > 0 ? Math.round((band.female / band.total) * 100) : 0;
...
// // //                                                     padding: '10px 16px', borderRadius: 0, cursor: 'pointer',
// // //                                                     background: isActive ? `${band.color}15` : 'var(--mlab-white)',
// // //                                                     borderStyle: 'solid',
// // //                                                     borderWidth: '1px 1px 1px 4px',
// // //                                                     borderColor: isActive ? `${band.color}40 ${band.color}40 ${band.color}40 ${band.color}` : 'var(--mlab-border)',
// // //                                                     transition: 'all 0.2s ease'
...
// // //                                                 </div>
// // //                                                 <div>
// // //                                                     <div style={{ width: '100%', background: '#e2e8f0', height: '8px', borderRadius: 0, overflow: 'hidden', marginBottom: '6px' }}>
// // //                                                         <div style={{ width: `${totalPct}%`, background: band.color, height: '100%', transition: 'width 0.5s ease' }} />
// // //                                                     </div>
// // //                                                     <div style={{ display: 'flex', gap: '1.5rem', fontSize: '0.75rem', fontWeight: 600 }}>
// // //                                                         <span style={{ color: '#0284c7', display: 'flex', alignItems: 'center', gap: '4px' }}><User size={12} /> M: <strong>{band.male}</strong> ({malePct}% of band)</span>
// // //                                                         <span style={{ color: '#ec4899', display: 'flex', alignItems: 'center', gap: '4px' }}><User size={12} /> F: <strong>{band.female}</strong> ({femalePct}% of band)</span>
// // //                                                     </div>
// // //                                                 </div>
// // //                                             </div>
// // //                                         );
...
// // // //                                         </div>
// // // //                                     </div>
// // // //                                     <button onClick={handleEnhanceText} disabled={isEnhancing} className="lfm-btn lfm-btn--ghost" style={{ cursor: isEnhancing ? 'not-allowed' : 'pointer' }}>
// // // //                                         {isEnhancing ? <Loader2 size={14} className="lfm-spin" /> : <Sparkles size={14} />} Enhance Highlighted Text
// // // //                                     </button>
// // // //                                 </div>
// // // //                                 <div style={{ background: 'white', color: '#000000', border: '1px solid var(--mlab-border)', borderRadius: 0, flex: 1, display: 'flex', flexDirection: 'column' }}>
...
// // // //             {/* 🚀 RESTORED MODALS FOR DROPOUT, STATUS, PORTFOLIO, ETC. */}
// // // //             {modalConfig.isOpen && createPortal(
// // // //                 <div style={{ position: 'relative', zIndex: 999999 }}>
// // // //                     <StatusModal type={modalConfig.type} title={modalConfig.title} message={modalConfig.message} onClose={() => setModalConfig(p => ({ ...p, isOpen: false }))} />
// // // //                 </div>,
...
// // // //                     {/* 🚀 TOGGLE BUTTON WITH NORMALIZED MARGINS */}
// // // //                     <div style={{ display: 'flex', justifyContent: 'flex-end', marginBottom: '1rem' }}>
// // // //                         <button
// // // //                             onClick={() => setShowKPIs(!showKPIs)}
// // // //                             style={{
...
// // // //                     {/* 🚀 BOOTCAMP KPIs REUSING PROGRESS CARDS (COLLAPSIBLE) */}
// // // //                     {showKPIs && cohortAnalytics && (
// // // //                         <div className="mc-cards-wrapper animate-slide-down">
// // // //                             <ModuleProgressCard
// // // //                                 type="Global Retention"
...
// // // //                     {/* 🚀 NAVY BLUE INTERACTIVE COMPLIANCE MATRIX */}
// // // //                     {cohortAnalytics && (
// // // //                         <div style={{ border: '2px solid var(--mlab-blue)', borderRadius: 0, backgroundColor: 'var(--mlab-white)', marginBottom: '2rem' }}>
// // // //                             <div
// // // //                                 className="lfm-header"
...
// // // //                     {/* 🚀 NAVY BLUE MASTER ASSESSMENTS ACCORDION */}
// // // //                     {assessmentStatsMap.length > 0 && (
// // // //                         <div style={{ border: '2px solid var(--mlab-blue)', background: 'var(--mlab-white)', marginBottom: '2rem', borderRadius: 0 }}>
...
// // // //                                                 disabled={currentPage === 1}
// // // //                                                 className="lfm-btn lfm-btn--ghost"
// // // //                                                 style={{ padding: '6px 12px', border: '1px solid #cbd5e1', display: 'flex', alignItems: 'center', gap: '6px', opacity: currentPage === 1 ? 0.5 : 1, borderRadius: 0 }}
// // // //                                             >
// // // //                                                 <ChevronLeft size={14} /> Previous
// // // //                                             </button>
// // // //                                             <div style={{ display: 'flex', alignItems: 'center', padding: '0 8px', fontSize: '0.85rem', fontWeight: 600, color: 'var(--mlab-midnight)' }}>
...
// // // //                                                 disabled={currentPage === totalPages}
// // // //                                                 className="lfm-btn lfm-btn--ghost"
// // // //                                                 style={{ padding: '6px 12px', border: '1px solid #cbd5e1', display: 'flex', alignItems: 'center', gap: '6px', opacity: currentPage === totalPages ? 0.5 : 1, borderRadius: 0 }}
// // // //                                             >
// // // //                                                 Next <ChevronRight size={14} />
// // // //                                             </button>
// // // //                                         </div>
...
// // // //                                                             </td>
// // // //                                                             <td>
// // // //                                                                 <span style={{ display: 'inline-flex', alignItems: 'center', gap: '6px', padding: '2px 6px', background: '#fffbeb', color: '#d97706', fontSize: '0.8rem', fontWeight: 600, borderRadius: '0', border: '1px solid #fcd34d' }}>
// // // //                                                                     <AlertCircle size={12} /> {log.totalPartial || 0}
// // // //                                                                 </span>
// // // //                                                             </td>
// // // //                                                             <td>
