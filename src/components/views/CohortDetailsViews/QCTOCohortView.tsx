...
// 🚀 IMPORT OUR NEW CALENDAR COMPONENT
import { CohortAttendanceCalendar } from '../../../components/common/CohortAttendanceCalendar/CohortAttendanceCalendar';
...
export const QCTOCohortView: React.FC<{ cohort: any }> = ({ cohort }) => {
    ...
    // 🚀 FIXED: Added 'calendar' to the activeTab state types
    const [activeTab, setActiveTab] = useState<'learners' | 'curriculum' | 'attendance' | 'calendar'>('learners');
    ...
    return (
        <div className="cdp-layout">
            ...
            {/* 🚀 CSS STYLES FOR MODULE PROGRESS CARDS */}
            <style>{`
                .mc-cards-wrapper {
                    display: grid;
                ...
                .mc { background: white; border: 1px solid var(--mlab-border); border-radius: 20px; padding: 22px 20px 18px; position: relative; overflow: hidden; display: flex; flex-direction: column; gap: 18px; transition: transform .22s ease, box-shadow .22s ease; cursor: default; }
                            ...
                            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1.5rem', flexWrap: 'wrap', gap: '1rem' }}>
                                ...
                                <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                                    ...
                                    <div style={{ display: 'flex', alignItems: 'center', gap: '1rem', background: '#f8fafc', padding: '6px', borderRadius: '8px', border: '1px solid #cbd5e1' }}>
                                        <button onClick={handlePrevMonth} style={{ padding: '6px', background: 'white', border: '1px solid #cbd5e1', borderRadius: '6px', cursor: 'pointer', display: 'flex' }}><ChevronLeft size={16} color="var(--mlab-midnight)" /></button>
                                        <span style={{ fontWeight: '800', width: '130px', textAlign: 'center', color: 'var(--mlab-midnight)' }}>{calendarMonth.format('MMMM YYYY')}</span>
                                        <button onClick={handleNextMonth} style={{ padding: '6px', background: 'white', border: '1px solid #cbd5e1', borderRadius: '6px', cursor: 'pointer', display: 'flex' }}><ChevronRight size={16} color="var(--mlab-midnight)" /></button>
                                    </div>
                                </div>
                            </div>
...
// // // // ─── NEW: PROGRESS CARD COMPONENT (PORTRAIT & LIGHT THEME) ──────────────────
...
// // //             // 🚀 FIX: Only sync workbooks for active learners! Dropped learners will not get new assignments.
// // //             const activeLearnersToSync = enrolledLearners.filter(l => l.status !== 'dropped');
...
// // //             {/* 🚀 NEW CSS FOR THE MODULE CARDS (LIGHT THEME) */}
// // //             <style>{`
// // //                 @keyframes live-dot-ping {
// // //                     0% { transform: scale(0.8); box-shadow: 0 0 0 0 rgba(239, 68, 68, 0.7); }
// // //                     50% { transform: scale(1.2); box-shadow: 0 0 0 8px rgba(239, 68, 68, 0); }
...
// // //                 .mc-hdr { display: flex; align-items: flex-start; justify-content: space-between; gap: 8px; position: relative; }
// // //                 .mc-icon { width: 38px; height: 38px; border-radius: 11px; display: flex; align-items: center; justify-content: center; flex-shrink: 0; }
// // //                 .mc-label { font-size: 9px; font-weight: 400; letter-spacing: .2em; text-transform: uppercase; color: var(--mlab-grey); margin-bottom: 4px; }
// // //                 .mc-title { font-size: 14px; font-weight: 700; color: var(--mlab-midnight); letter-spacing: -0.2px; line-height: 1.2; }
// // //                 .mc-pct { font-size: 24px; font-weight: 600; letter-spacing: -0.5px; flex-shrink: 0; margin-top: 1px; }
...
// // //                 .mc-bars { display: flex; flex-direction: column; gap: 8px; }
// // //                 .mc-bar-meta { display: flex; align-items: center; justify-content: space-between; margin-bottom: 5px; }
// // //                 .mc-bar-lbl { font-size: 8px; font-weight: 500; letter-spacing: .16em; text-transform: uppercase; color: var(--mlab-grey); }
// // //                 .mc-bar-val { font-size: 10px; font-weight: 700; color: var(--mlab-midnight); }
// // //                 .mc-track { width: 100%; height: 5px; background: #f1f5f9; border-radius: 3px; overflow: hidden; }
// // //                 .mc-fill { height: 100%; border-radius: 3px; transition: width 1.4s cubic-bezier(.4,0,.2,1) .35s; }
...
// // //                 .mc-total { font-size: 11px; font-weight: 500; color: var(--mlab-grey); }
// // //                 .mc-total strong { font-weight: 800; color: var(--mlab-midnight); }
// // //                 .mc-status { display: inline-flex; align-items: center; gap: 5px; border-radius: 20px; padding: 4px 10px; font-size: 8px; font-weight: 600; letter-spacing: .12em; text-transform: uppercase; }
...
// // //                                                             <td style={{ textAlign: 'right' }}>
// // //                                                                 <div className="cdp-actions" style={{ justifyContent: 'flex-end', display: 'flex', gap: '8px' }}>
// // //                                                                     {isAdmin && <div className="cdp-learner-cell__info"> <button className={`cdp-btn ${isPlaced ? 'cdp-btn--outline' : 'cdp-btn--primary'} cdp-pending-chip`} style={{ padding: '4px 8px', fontSize: '0.75rem' }} onClick={() => setLearnerToPlace(learner)}><Briefcase size={12} /> {isPlaced ? 'Reassign' : 'Place'}</button> </div>}
// // //                                                                     <button className="cdp-btn cdp-btn--outline" style={{ padding: '4px 8px', fontSize: '0.75rem' }} onClick={() => navigate(`/portfolio/${routingId}`, { state: { cohortId: cohort.id } })}><FolderOpen size={12} /> Portfolio</button>
...
// // // //             // Note: The success toast fires inside the parent's handleConfirmDrop function!
...
// // // //             {/* 🚀 NEW: Added ToastContainer so alerts actually render on screen */}
// // // //             <ToastContainer toasts={toast.toasts} onClose={toast.closeToast} />
