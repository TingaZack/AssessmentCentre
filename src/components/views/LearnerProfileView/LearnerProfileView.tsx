...
import { SkillsSelector, type SkillItem } from '../../common/SkillsSelector/SkillsSelector';
...
export const LearnerProfileView: React.FC = () => {
    ...
    const [formData, setFormData] = useState<Partial<DashboardLearner & { skills: SkillItem[] }>>({});
    ...
    const update = (field: keyof (DashboardLearner & { skills: SkillItem[] }), val: any) =>
                        ...
                        <div className="lpv-layout">
                            ...
                            <div className="lpv-main-stack">
                                ...
                                <section className="lpv-panel">
                                    <div className="lpv-panel__header">
                                        <h3 className="lpv-panel__title">
                                            <Code size={15} /> Technical Skills &amp; Competencies
                                        </h3>
                                    </div>
                                    <div style={{ padding: '0.5rem 0' }}>
                                        <SkillsSelector
                                            value={formData.skills || (profile as any)?.skills || []}
