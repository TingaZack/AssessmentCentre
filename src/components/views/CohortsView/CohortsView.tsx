...
import {
    ...
    Edit, DownloadCloud, Loader2, FileSpreadsheet, Zap
} from 'lucide-react';
                        ...
                        <div key={cohort.id} className="mlab-cohort-card animate-fade-in">
                            ...
                            <div className="mlab-role-row-stack">
                                ...
                                {!isBootcamp ? (
                                    ...
                                    <>
                                        {/* BOOTCAMP METRICS (Fills the white space) */}
                                        <div className="mlab-role-row">
                                            ...
                                            <span className="mlab-role-name">
                                                {settings?.campuses?.find((c: any) => c.id === cohort.campusId)?.name || 'Online / Hybrid'}
                                            </span>
                                        </div>
                                        <div className="mlab-role-row">
                                            <div className="mlab-role-dot" style={{ background: '#f59e0b' }} />
                                            <span className="mlab-role-label">Applicants:</span>
                                            <span className="mlab-role-name">{cohort.learnerIds?.length || 0} Registered</span>
                                        </div>
                                    </>
                                )}
                            </div>
