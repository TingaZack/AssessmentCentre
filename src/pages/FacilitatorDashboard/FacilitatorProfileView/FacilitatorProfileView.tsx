...
export const FacilitatorProfileView: React.FC<ProfileProps> = ({ profile, user, onUpdate }) => {
    ...
    // Determines the "Ink" color for the signature display label
    const getPenColorLabel = () => {
    ...
    useEffect(() => {
        // Ensure this only applies if the person viewing is the actual facilitator (not an Admin editing them)
                ...
                <div className="lpv-main-stack">
                    ...
                    <section className="lpv-panel">
                        ...
                        <div className="lpv-grid-2">
                            ...
                            <EditField label="Years Experience" value={displayData?.yearsExperience?.toString()} icon={<Briefcase size={13} />} isEditing={isEditing} onChange={val => update('yearsExperience', parseInt(val) || 0)} />
                        </div>
                        <div className="lpv-divider" />
                        <div className="lpv-fg">
                            <div className="lpv-field__label"><Info size={13} /> Professional Bio & Expertise</div>
                            {isEditing ? (
                            ...
                            {liveProfile?.signatureUrl ? (
                                <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
                                    <img
                                        ...
                                        alt="Registered Digital Signature"
                                    ...
                                    <span style={{ fontSize: '0.7rem', color: '#94a3b8', textTransform: 'uppercase', letterSpacing: '0.05em', marginTop: '10px' }}>
                                        Authenticated Digital Signature ({getPenColorLabel()} ink)
                                    </span>
                                </div>
                            ) : (
