...
import {
    ...
    Briefcase, Globe, Calendar, BookOpen, Clock, PenTool, MapPin
} from 'lucide-react';
                                ...
                                onClick={() => {
                                    ...
                                    if (isEditing) {
                                        const sameAsRes = profile.sameAsResidential !== undefined
                                            ? profile.sameAsResidential
                                            : (profile.postalAddress === profile.streetAddress || !profile.postalAddress);
                                        setFormData({ ...profile, sameAsResidential: sameAsRes });
                ...
                <aside className="lpv-aside">
                    ...
                    <div className="lpv-vault-card">
                        ...
                        <div className="lpv-vault-links">
                            ...
                            <DocVaultLink label="Facilitator Certificate" url={profile?.complianceDocs?.facilitatorCertUrl} />
                        </div>
                    </div>
...
//     User, Mail, Phone, ShieldCheck, FileText, Edit3, Save, X,
//     Fingerprint, GraduationCap, AlertCircle, Info, Loader2, Camera,
//     Briefcase, Globe, Calendar, BookOpen, Clock, PenTool
// } from 'lucide-react';
// import { ref, uploadBytes, getDownloadURL } from 'firebase/storage';
// import { storage } from '../../../lib/firebase';
// import './FacilitatorProfileView.css';
...
//                     onComplete={() => {
//                         setIsSigModalOpen(false);
//                         window.location.reload(); // Refresh to show new signature
//                     }}
//                 />
//             )}
...
//                             Your signature is captured using Biometric Ink Tracking. Per QCTO compliance, it is color-coded to your role.
//                         </p>
//                     </section>
...
// const EditField = ({ label, value, isEditing, onChange, icon }: { label: string; value?: string; isEditing: boolean; onChange: (val: string) => void; icon?: React.ReactNode; }) => (
//     <div>
//         <div className="lpv-field__label">{icon}{label}</div>
//         {isEditing ? (
//             <input type="text" className="lpv-input" value={value || ''} onChange={e => onChange(e.target.value)} />
