...
import {
    ...
    Camera, Award, Calendar, Briefcase, PenTool, Clock
} from 'lucide-react';
                ...
                <aside className="lpv-aside">
                    ...
                    <div className="lpv-vault-card">
                        ...
                        <div className="lpv-vault-links">
                            ...
                            <DocVaultLink label="Assessor Certificate" url={profile?.complianceDocs?.assessorCertUrl} />
...
//     User, Mail, Phone, ShieldCheck, FileText, Edit3, Save, X,
//     Fingerprint, GraduationCap, AlertCircle, Info, Loader2,
//     Camera, Award, Calendar, Briefcase
// } from 'lucide-react';
// import { ref, uploadBytes, getDownloadURL } from 'firebase/storage';
// import { storage } from '../../../lib/firebase';
// import './AssessorProfileView.css';
...
//             // ✅ Upload new photo if selected when saving
//             if (profilePhoto && user?.uid) {
//                 const ext = profilePhoto.name.split('.').pop();
//                 finalPhotoUrl = await handleFileUpload(profilePhoto, `staff/${user.uid}/profile_${Date.now()}.${ext}`);
//             }
...
//                         {/* ✅ NEW PROFILE PHOTO AREA (Matched to LearnerProfileView) */}
//                         <div style={{ display: 'flex', alignItems: 'center', gap: '1.5rem', marginBottom: '2rem', padding: '1rem', background: '#f8fafc', borderRadius: '8px', border: '1px solid #e2e8f0' }}>
//                             <div style={{ position: 'relative' }}>
//                                 <div style={{ width: '70px', height: '70px', borderRadius: '50%', background: '#e2e8f0', overflow: 'hidden', display: 'flex', alignItems: 'center', justifyContent: 'center', border: '3px solid white', boxShadow: '0 2px 5px rgba(0,0,0,0.1)' }}>
//                                     {photoPreview ? (
...
//                                 <h4 style={{ margin: '0 0 0.25rem 0', color: '#0f172a', fontSize: '1.05rem' }}>{formData?.fullName || 'Practitioner'}</h4>
//                                 <p style={{ margin: 0, color: '#64748b', fontSize: '0.85rem' }}>
//                                     {isEditing ? 'Click the camera icon to update your photo.' : 'Practitioner Profile'}
//                                 </p>
//                             </div>
//                         </div>
...
//                                 />
//                             ) : (
//                                 <div className="lpv-field__value" style={{ fontWeight: 'normal', lineHeight: '1.6', textAlign: 'justify' }}>
//                                     {profile?.bio || 'No professional bio provided.'}
//                                 </div>
//                             )}
//                         </div>
...
// //     User, Mail, Phone, ShieldCheck, FileText, Edit3, Save, X,
// //     Fingerprint, GraduationCap, AlertCircle, Info, Loader2,
// //     Camera, Award, Calendar, Globe, Briefcase
// // } from 'lucide-react';
// // import { ref, uploadBytes, getDownloadURL } from 'firebase/storage';
// // import { storage } from '../../../lib/firebase';
// // import './AssessorProfileView.css';
...
// //     // ─── Data Initialization ──────────────────────────────────────────────
// //     // We initialize with whatever is in profile, but we MUST sync it.
// //     const [formData, setFormData] = useState({ ...profile });
// //     const [profilePhoto, setProfilePhoto] = useState<File | null>(null);
// //     const [photoPreview, setPhotoPreview] = useState<string | null>(profile?.profilePhotoUrl || null);
...
// //     useEffect(() => {
// //         if (profile) {
// //             console.log("Profile Data Received:", profile); // Debugging
// //             setFormData({ ...profile });
// //             setPhotoPreview(profile.profilePhotoUrl || null);
// //         }
// //     }, [profile]);
...
// //                         <div className="lpv-photo-section">
// //                             <div className="lpv-avatar-container">
// //                                 <div className="lpv-avatar-circle">
// //                                     {photoPreview ? (
...
// //                                 </div>
// //                                 {isEditing && (
// //                                     <label className="lpv-photo-upload-label">
// //                                         <Camera size={14} />
// //                                         <input type="file" accept="image/*" onChange={handlePhotoSelect} style={{ display: 'none' }} />
// //                                     </label>
// //                                 )}
// //                             </div>
// //                             <div className="lpv-header-info">
// //                                 <h4 className="lpv-user-name">{formData?.fullName || 'Practitioner'}</h4>
// //                                 <span className="lp-role-tag">{profile?.role?.toUpperCase()}</span>
// //                             </div>
// //                         </div>
