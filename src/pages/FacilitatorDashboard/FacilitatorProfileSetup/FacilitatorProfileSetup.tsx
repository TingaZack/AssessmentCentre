// src/pages/FacilitatorPortal/FacilitatorProfileSetup.tsx
...
export const FacilitatorProfileSetup: React.FC = () => {
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            const finalData = {
                ...formData,
                role: user?.role || 'facilitator', // 🚀 HARMONIZATION FIX: Explicitly protects the existing staff role tag!
                    ...
                    <div className="lp-form-body animate-fade-in">
                        ...
                        <div className="setup-photo-upload">
                            <div className="setup-avatar-circle">
                                {photoPreview ? <img src={photoPreview} alt="Preview" crossOrigin="anonymous" style={{ width: '100%', height: '100%', objectFit: 'cover' }} /> : <User size={40} color="#94a3b8" />}
                            </div>
