...
export const AttendanceHistoryList: React.FC<{ facilitatorId?: string }> = ({ facilitatorId }) => {
    ...
    const availableCohorts = useMemo(() => {
        ...
        // 🚀 FIX: Ensure we check both facilitatorId AND supportFacilitatorId
        ...
        const fetchData = async () => {
            ...
            try {
                ...
                if (isAdmin) {
                    ...
                    // 🚀 FIX: Use availableCohorts to get ALL cohort IDs they are assigned to (primary OR assistant)
                    ...
                    if (myCohortIds.length > 0) {
                        ...
                        // If they have no cohorts, force an empty query
                ...
                // Because we couldn't orderBy('date', 'desc') alongside 'in' easily without composite indexes,
                // we sort it in memory for the Assistant Facilitators.
                if (!isAdmin) {
