        ...
        const fetchData = async () => {
            ...
            try {
                ...
                if (isAdmin) {
                    ...
                    qHist = query(collection(db, 'attendance'), where('facilitatorId', '==', facilitatorId), orderBy('date', 'desc'));
                }
                ...
                if (isAdmin) {
                    ...
                    qKiosk = query(collection(db, 'kiosk_sessions'), where('facilitatorId', '==', facilitatorId), where('date', '==', todayStr), where('status', '==', 'active'));
                }
