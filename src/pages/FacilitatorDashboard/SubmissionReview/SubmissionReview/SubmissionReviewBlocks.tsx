...
import {
    ...
    ShieldCheck, Award as AwardIcon, BarChart, AlertCircle, Sigma, Lock, Loader2
} from 'lucide-react';
...
// 🚀 FIX: Smart Sandbox Wrapper that dynamically fetches cloud storage code snapshots for reviewers
const ReviewCodeSandbox: React.FC<{ block: any, learnerAns: any, submissionId: string }> = ({ block, learnerAns, submissionId }) => {
    ...
    useEffect(() => {
        ...
        // If the code was too big for Firestore, fetch it from the Cloud Storage Bucket
    ...
    return (
        <>
            {assessment.blocks.map((block: any) => {
                ...
                // ── QUESTION / TASK / CHECKLIST / LOGBOOK / WORKPLACE / CODE SANDBOX / MATHPAD ──
                if (['mcq', 'text', 'task', 'checklist', 'logbook', 'qcto_workplace', 'code_sandbox', 'mathpad'].includes(block.type)) {
                    ...
                    const mentorActiveOnScorableBlock = isMentor && canFacilitatorMark && ['mcq', 'text', 'task', 'code_sandbox', 'mathpad'].includes(block.type);
                            ...
                            <div key={block.id} className="sr-q-card" style={{ borderTop: '4px solid black', marginBottom: '2rem' }}>
                                ...
                                <div className="sr-q-body">
                                    ...
                                    <div className="sr-answer-box">
                                        <div className="sr-answer-label" style={{ color: 'black', marginBottom: '8px' }}><Sigma size={14} style={{ display: 'inline', marginBottom: '-2px', marginRight: '4px' }} />Learner's Math Response:</div>
                                        ...
                                        {/* Assessor Memorandum Block */}
                                        {(block.correctAnswer || block.modelSolution) && (
                        ...
                        return (
                            <div key={block.id} className="sr-q-card" style={{ borderTop: '4px solid black', marginBottom: '2rem' }}>
                                ...
                                <div className="sr-q-body">
                                    ...
                                    {/* 🚀 FIX: Connect the IDE to the dynamic cloud storage fetcher */}
                                    <ReviewCodeSandbox
                                        block={block}
...
//     Award, Check, CheckCircle, X, Edit3, Info, Layers, FileText, Mic,
//     UploadCloud, Code, Link as LinkIcon, CalendarRange, Timer, Play, Square,
//     ShieldCheck, Award as AwardIcon, BarChart, AlertCircle, Sigma, Lock
// } from 'lucide-react';
// import moment from 'moment';
// import { LogbookHoursTally } from './SubmissionReviewHelpers';
// import { FilePreview } from './SubmissionReviewPreviews';
...
//     // 🚀 FIX: Prevent React from crashing if blocks are undefined while loading
//     if (!assessment?.blocks || !Array.isArray(assessment.blocks)) return null;
