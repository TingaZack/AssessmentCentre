...
// 🚀 CRITICAL: Import AdminDashboard CSS so the dashboard-header gets styled!
...
//                         activeTab === 'history' ? 'Review past attendance registers.' :
//                             activeTab === 'profile' ? 'View and update your profile information.' :
//                                 'Create and manage assessments for your learners.'
//                 }
//                 actions={
//                     activeTab === 'assessments' && (
//                         <PageHeader.Btn
//                             variant="primary"
//                             icon={<Plus size={15} />}
//                             onClick={() => { /* Implement assessment creation hook */ }}
//                         >
//                             New Assessment
//                         </PageHeader.Btn>
//                     )
...
// // export const FacilitatorDashboard: React.FC = () => {
// //     // 🚀 Brought in the state arrays to check if we already have the data
// //     const {
// //         user,
// //         cohorts,
// //         learners,
...
// // //     // ─── ALIGNED DATA HYDRATION (Mirroring AdminDashboard) ───────────────────
// // //     // This ensures all sub-components have immediate access to necessary global state
// // //     useEffect(() => {
// // //         if (activeTab === 'dashboard') {
// // //             fetchCohorts();
// // //             fetchLearners(); // Needed to calculate accurate learner counts/stats
// // //         }
...
// // //         if (activeTab === 'assessments') {
// // //             fetchCohorts();
// // //             fetchProgrammes(); // Needed for assessment templates
// // //         }

// // //         if (activeTab === 'profile') {
// // //             fetchEmployers(); // In case the facilitator/mentor needs to link to an employer
// // //             fetchStaff();     // Ensures the profile is up to date
// // //         }
// // //     }, [activeTab, fetchCohorts, fetchLearners, fetchProgrammes, fetchStaff, fetchEmployers]);
