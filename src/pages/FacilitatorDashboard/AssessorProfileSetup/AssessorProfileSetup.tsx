...
import {
    ...
    Save, ChevronRight, ShieldCheck, Loader2, Camera, Award, Calendar, Fingerprint, Globe, MapPin, Phone
} from 'lucide-react';
                    ...
                    <div className="lp-form-body animate-fade-in">
                        ...
                        <div className="lp-popia-box" style={{ background: '#f8fafc', padding: '1.25rem', borderRadius: '8px', border: '1px solid #cbd5e1', marginTop: '2rem' }}>
                            ...
                            <p style={{ margin: '0 0 1rem 0', fontSize: '0.9rem', color: '#475569' }}>
                                I formally consent to the processing of my data for QCTO compliance. Furthermore, I declare the above details to be true and agree to the QCTO Code of Conduct.
                            </p>
                        ...
                        <div className="lp-actions">
                            ...
                            <button className="lp-btn-primary" onClick={handleSubmit} disabled={loading || !formData.popiaConsent || !idDoc || !assessorCert || !regLetter}>
