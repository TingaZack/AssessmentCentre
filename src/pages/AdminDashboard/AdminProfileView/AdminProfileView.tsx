...
// We keep AssessorProfileView.css purely for the internal form field styling (lpv-input, lpv-field__label)
...
export const AdminProfileView: React.FC<ProfileProps> = ({ profile, user, onUpdate }) => {
    ...
    // 🚀 The Single Source of Truth (Real-time DB State)
...
//                     userUid={targetId}
//                     onComplete={() => {
//                         // Just sit back and let the Snapshot Listener automatically close the modal
//                     }}
//                 />
//             )}

//             <div className="lpv-wrapper animate-fade-in" style={{ padding: '0' }}>
//                 <div className={`lpv-banner ${isVerified ? 'lpv-banner--verified' : 'lpv-banner--pending'}`} style={isSuper ? { background: '#fef2f2', borderLeft: '5px solid #ef4444' } : isVerified ? { background: '#f1f5f9', borderLeftColor: '#0f172a' } : {}}>
//                     {isSuper ? <Shield size={22} color="#ef4444" className="lpv-banner__icon" /> : <ShieldCheck size={22} className="lpv-banner__icon" color={isVerified ? '#0f172a' : 'var(--mlab-amber)'} />}
//                     <div style={{ flex: 1 }}>
//                         <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
//                             <span className="lpv-banner__title" style={{ color: isSuper ? '#ef4444' : isVerified ? '#0f172a' : 'inherit', fontFamily: 'var(--font-heading)', textTransform: 'uppercase' }}>
...
//                             <p className="lpv-qual-card__name">{isSuper ? 'Super Admin' : (liveProfile?.jobTitle || 'Administrator')}</p>
//                             <span className="lpv-qual-card__saqa">System Role: {liveProfile?.role?.toUpperCase() || 'ADMIN'}</span>
//                         </div>
...
//                                     {isEditing && <button type="button" className="lpv-edit-btn" style={{ fontSize: '0.75rem', padding: '4px 8px', display: 'flex', alignItems: 'center', gap: '4px' }} onClick={handleAddDocument}><Plus size={12} /> Add</button>}
//                                 </div>
//                                 {renderDocumentVault()}
//                             </div>
//                         )}
...
//                         <div className="lpv-vault-card">
//                             <h4 className="lpv-vault-card__title" style={{ color: '#0f172a' }}><Key size={15} /> Authorized Signature</h4>
//                             <p style={{ fontSize: '0.72rem', color: 'var(--mlab-grey)', margin: '4px 0 12px 0' }}>Required for institutional sign-offs and certificates.</p>

//                             <div style={{ background: '#f8fafc', border: '1px dashed #cbd5e1', padding: '1rem', display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', minHeight: '80px' }}>
//                                 {liveProfile?.signatureUrl ? (
//                                     <>
//                                         <img src={liveProfile.signatureUrl} alt="Signature" style={{ maxHeight: '60px', maxWidth: '100%', objectFit: 'contain' }} />
//                                         {isEditing && (
//                                             <button type="button" onClick={(e) => { e.preventDefault(); setShowSignatureModal(true); }} style={{ marginTop: '10px', fontSize: '10px', color: '#0ea5e9', cursor: 'pointer', display: 'flex', alignItems: 'center', gap: '4px', background: 'transparent', border: 'none' }}>
//                                                 <Edit3 size={10} /> Redraw Signature
//                                             </button>
//                                         )}
//                                     </>
//                                 ) : (
//                                     <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '8px' }}>
//                                         <span style={{ fontSize: '0.75rem', color: '#ef4444', fontWeight: 600 }}>Action Required: Signature Missing</span>
//                                         <button type="button" onClick={(e) => { e.preventDefault(); setShowSignatureModal(true); }} style={{ cursor: 'pointer', display: 'flex', alignItems: 'center', gap: '6px', padding: '6px 12px', background: '#0f172a', color: '#fff', border: 'none', borderRadius: '4px', fontSize: '11px' }}>
//                                             <Plus size={12} /> Draw Signature
//                                         </button>
//                                     </div>
//                                 )}
...
// //     // 2. HYDRATE UI FROM LIVE PROFILE (Only when NOT editing)
// //     // This perfectly handles the "Cancel" action automatically!
// //     useEffect(() => {
// //         if (!isEditing && liveProfile) {
// //             const sameAsRes = liveProfile.sameAsResidential !== undefined
// //                 ? liveProfile.sameAsResidential
...
// //                     onComplete={() => {
// //                         // Just sit back and let the Snapshot Listener automatically close the modal
// //                         // when the new signature URL arrives!
// //                     }}
// //                 />
// //             )}
...
// //                                             <div className="lpv-grid-2">
// //                                                 <ROField label="Address" value={displayData.postalAddress} />
// //                                                 <ROField label="Postal Code" value={displayData.customPostalCode} />
// //                                             </div>
// //                                         </>
// //                                     )
// //                                 )}
...
// //                             <div style={{ background: '#f8fafc', border: '1px dashed #cbd5e1', padding: '1rem', display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', minHeight: '80px' }}>
// //                                 {/* Always rely on the liveProfile signatureUrl */}
// //                                 {liveProfile?.signatureUrl ? (
// //                                     <>
// //                                         <img src={liveProfile.signatureUrl} alt="Signature" style={{ maxHeight: '60px', maxWidth: '100%', objectFit: 'contain' }} />
// //                                         {isEditing && (
