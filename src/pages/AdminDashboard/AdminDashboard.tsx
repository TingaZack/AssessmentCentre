...
//     // ----- Load Data -----
//     useEffect(() => {
//         // 🚀 PRE-CHECK PRIVILEGES BEFORE FETCHING FROM FIREBASE
//         const currentUser = user as any;
//         const isSuper = currentUser?.isSuperAdmin === true;
//         const privs = currentUser?.privileges || {};

//         if (currentNav === 'dashboard') {
//             if (isSuper || privs.learners) store.fetchLearners();
//             if (isSuper || privs.learners) store.fetchStagingLearners();
//             if (isSuper || privs.cohorts) store.fetchCohorts();
//             if (isSuper || privs.staff) store.fetchStaff();
//         }
...
//     // 🚀 NEW: STRICT ACCESS CONTROL INTERCEPTOR
//     const checkAccess = (tab: NavTabs) => {
//         const currentUser = user as any;
...
//                 'studio': !!privs.studio,
//                 'settings': !!privs.settings,
//                 'coaching': !!privs.cohorts // Ties coaching access to cohort access
//             };
...
//                 <div className="admin-content">
//                     {/* 🚀 ENFORCEMENT CHECK: Block unprivileged access */}
//                     {!hasAccess ? (
//                         <div style={{ textAlign: 'center', padding: '4rem', color: '#ef4444', border: '1px solid #fecaca', background: '#fef2f2', borderRadius: '8px' }}>
//                             <ShieldAlert size={48} style={{ margin: '0 auto 1rem' }} />
//                             <h2>Unauthorized Access</h2>
...
//             {/* MODALS */}
//             {/* ... Modal rendering code remains identical to original ... */}
//             {showAddLearnerModal && (
//                 <LearnerFormModal
//                     learner={selectedLearner || undefined}
//                     title={selectedLearner ? 'Edit Enrollment' : 'Add New Enrollment'}
...
// // // 🚀 NEW: Added 'coaching' to the NavTabs
// // type NavTabs = 'directory' | 'learners' | 'staff' | 'qualifications' | 'cohorts' |
// //     'workplaces' | 'studio' | 'dashboard' | 'profile' | 'access' |
// //     'assessments' | 'settings' | 'attendance' | 'ecosystem' | 'company-profile' | 'coaching';
...
// //     // URL Query Parameter State Synchronization
// //     const [searchParams, setSearchParams] = useSearchParams();

// //     // Extract the tab from the URL, fallback to 'dashboard' if missing
// //     const currentNav = (searchParams.get('tab') as NavTabs) || 'dashboard';

// //     // Safely update the URL without pushing history stacks or destroying sub-params
// //     const setCurrentNav = (tab: NavTabs) => {
// //         const params = new URLSearchParams(searchParams);
// //         if (tab === 'dashboard') {
// //             params.delete('tab');
...
// //         // If navigating to a completely new major tab, it's safer to clear sub-views.
// //         params.delete('view');

// //         // Clear sub-views (like staff profile) when navigating away
// //         if (tab !== 'staff') setViewingStaffProfile(null);
...
// //     // Hold the staff member being viewed
// //     const [viewingStaffProfile, setViewingStaffProfile] = useState<StaffMember | null>(null);
...
// //             }
// //             // Also update local staff array if editing someone else
// //             if (store.updateStaffProfile) {
// //                 await store.updateStaffProfile(id, updates);
// //             }
// //             toast.success("Profile updated successfully.");
// //         } catch (err) {
// //             console.error("Profile update failed:", err);
...
// //                         viewingStaffProfile ? (
// //                             <div className="animate-fade-in" style={{ position: 'relative' }}>
// //                                 {/* Back button explicitly layered above the profile view */}
// //                                 <div style={{ marginBottom: '1rem', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
// //                                     <button
// //                                         onClick={() => setViewingStaffProfile(null)}
// //                                         className="wm-btn wm-btn--ghost"
...
// // // //     // 🚀 NEW STATE: Hold the staff member being viewed
// // // //     const [viewingStaffProfile, setViewingStaffProfile] = useState<StaffMember | null>(null);
...
// // // //                                     user={viewingStaffProfile}
// // // //                                     onUpdate={handleUpdateAdminProfile}
// // // //                                     hideSignaturePrompt={true} /* 🚀 This definitively blocks the popup */
// // // //                                 />
// // // //                             </div>
// // // //                         ) : (
// // // //                             <StaffView
