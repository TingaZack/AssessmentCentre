...
interface AdminData {
    ...
    signatureUrl?: string; // 🚀 Added signatureUrl tracking
}
...
export const AdminProfileSetup: React.FC = () => {
    ...
    const [docsList, setDocsList] = useState<DynamicDocument[]>([
        ...
        // 🚀 Added Required Signature Upload
        { id: 'signature', name: 'Scanned Official Signature (Clear Background)', file: null, url: '', isFixed: true, isRequired: true }
    ]);
        ...
        if (user) {
            ...
            if (u.uploadedDocuments && Array.isArray(u.uploadedDocuments)) {
                setDocsList(prev => {
                    ...
                    // 🚀 Hydrate signature from the root user object if it exists there
                    if (u.signatureUrl) {
                        const sigIdx = updatedList.findIndex(d => d.id === 'signature');
                        if (sigIdx >= 0) {
                            updatedList[sigIdx].url = u.signatureUrl;
                        }
                    }
                ...
                setDocsList(prev => {
                    ...
                    if (u.signatureUrl) {
                        const idx = updatedList.findIndex(d => d.id === 'signature');
                        if (idx >= 0) updatedList[idx].url = u.signatureUrl;
                    }
                    return updatedList;
                });
            }
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            let finalSignatureUrl = (user as any)?.signatureUrl || ""; // 🚀 Extract Signature to root
            ...
            for (const docItem of docsList) {
                ...
                if (finalUrl) {
                    ...
                    // 🚀 Specifically pull the signature out to the root user node for certificates
                    if (docItem.id === 'signature') finalSignatureUrl = finalUrl;
                }
            }
            ...
            const finalData = {
                ...
                signatureUrl: finalSignatureUrl, // 🚀 Saved explicitly for System Exports
                uploadedDocuments: finalUploadedDocs,
                complianceDocs: { ...legacyDocsObject, updatedAt: new Date().toISOString() },
                ...
                {step === 3 && (
                    <div className="lp-form-body animate-fade-in">
                        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1.5rem' }}>
                            <div>
                                <h3 className="lp-section-title" style={{ margin: 0, borderBottom: 'none', paddingBottom: 0 }}><ShieldCheck size={16} /> Official Documents & Signature</h3>
                                <p style={{ fontSize: '0.85rem', color: '#64748b', margin: '4px 0 0 0' }}>
                                    Please upload your verified compliance documents. <strong>ID, Appointment Letter, and Signature are mandatory.</strong>
                                </p>
                            </div>
                        ...
                        <div style={{
                            ...
                            <div>
                                ...
                                <p style={{ fontSize: '0.85rem', color: '#475569', margin: 0, lineHeight: 1.5 }}>
                                    <strong>I formally consent to the processing of my data for QCTO compliance.</strong> By checking this box, I confirm that I have read and agree to the <a href="/terms" target="_blank" rel="noopener noreferrer" style={{ color: '#0ea5e9', textDecoration: 'underline' }}>Terms & Conditions</a> and the <a href="/privacy-policy" target="_blank" rel="noopener noreferrer" style={{ color: '#0ea5e9', textDecoration: 'underline' }}>POPIA Privacy Policy</a>. Furthermore, I declare the above to be true and confirm that I am authorized by this institution to act as a Compiler and system Administrator / Assistance Admin.
                                </p>
                            </div>
                        </div>
...
//                                 </p> */}
//                                 <p style={{ fontSize: '0.85rem', color: '#475569', margin: 0, lineHeight: 1.5 }}>
//                                     <strong>I formally consent to the processing of my data for QCTO, SETA and other mLab Programme compliance requirements, .</strong> By checking this box, I confirm that I have read and agree to the <a href="/terms" target="_blank" rel="noopener noreferrer" style={{ color: '#0ea5e9', textDecoration: 'underline' }}>Terms & Conditions</a> and the <a href="/privacy-policy" target="_blank" rel="noopener noreferrer" style={{ color: '#0ea5e9', textDecoration: 'underline' }}>POPIA Privacy Policy</a>. Furthermore, I declare the above to be true and confirm that I am authorized by this institution to act as a Compiler and system Administrator / Assistance Admin.
//                                 </p>
//                             </div>
//                         </div>
