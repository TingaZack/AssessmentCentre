...
import {
    ...
    ShieldAlert, User, Save, UploadCloud, Loader2, AlertCircle, Plus, Trash2, MapPin, Database, Lock, CheckCircle2, Edit2, Globe, BookOpen, Wifi, X, Search, Clock, Send, MessageSquare, History, ListPlus
} from 'lucide-react';
...
const DEFAULT_SETTINGS: any = {
    ...
    // Default Global Demographic Fields
            ...
            <main className="main-wrapper settings-wrapper">
                ...
                <div className="settings-container">
                    ...
                    <div className="settings-content">
                        ...
                        {/* 🚀 NEW: ECOSYSTEM CRM CONFIGURATION */}
                        {activeTab === 'ecosystem' && (
                            <div className="settings-section animate-fade-in">
