...
// ... Keep existing QCTO Dictionaries ...
const QCTO_EQUITY = [
...
interface LearnerProfileData {
    ...
    skills: SkillItem[]; // 🚀 NEW: Skills Array
}
            ...
            try {
                ...
                if (learnerData) {
                    ...
                    setFormData({
                        ...
                        nokPhone: nok.phone || '',
                        skills: learnerData.skills || [] // 🚀 Load existing skills
                    });
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            const finalData: any = {
                ...
                skills: formData.skills || [], // 🚀 Save skills array
                ...
                <div className="lp-card">
                    ...
                    {step === 2 && (
                        <div className="lp-form-body animate-fade-in">
                            ...
                            {/* 🚀 NEW: TECHNICAL SKILLS & PROFICIENCY CHIPS SECTION */}
...
//         }));
//         toast.success(`Exact coordinates pinned: ${tempCoords.lat.toFixed(6)}, ${tempCoords.lng.toFixed(6)}`);
//         setIsMapModalOpen(true); // Keeping modal open just in case, but usually we close it.
//         setTimeout(() => setIsMapModalOpen(false), 300);
//     };
...
//     // 🚀 STRICT VALIDATION BEFORE ALLOWING PROGRESS TO STEP 3
//     const handleNextToStep3 = () => {
//         if (!formData.lat || !formData.lng || (formData.lat === 0 && formData.lng === 0)) {
//             toast.warning("Please use the Google Maps search to find and confirm your exact location.");
//             return;
...
//                                         placeholder="Use Maps search above..."
//                                     />
//                                 </FG>
...
//                                         style={{ backgroundColor: '#f1f5f9', color: '#64748b', cursor: 'not-allowed', opacity: 1 }}
//                                     >
//                                         <option value="">Use Maps search above...</option>
...
//                                 {/* 🚀 EXPLICIT MUNICIPALITY & DISTRICT AUTO-FILLED INPUTS */}
//                                 <FG label="Local Municipality (Auto-filled) *">
//                                     <input
//                                         className="lp-input"
//                                         readOnly
...
//                                         style={{ backgroundColor: '#f1f5f9', color: '#64748b', cursor: 'not-allowed' }}
//                                         placeholder="Select STATS-SA Code above..."
//                                     />
//                                 </FG>
//                                 <FG label="District / Metro (Auto-filled)">
//                                     <input
...
// // //         // Check required documents dynamically using toast
// // //         const missingRequired = docsList.filter(d => d.isRequired && !d.file && !d.url);
// // //         if (missingRequired.length > 0) {
// // //             toast.warning(`Please upload all required documents: ${missingRequired.map(d => d.name).join(', ')}`);
// // //             return;
