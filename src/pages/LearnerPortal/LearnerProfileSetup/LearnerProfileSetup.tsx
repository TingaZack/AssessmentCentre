                ...
                <div className="lp-card">
                    ...
                    {step === 2 && (
                        <div className="lp-form-body animate-fade-in">
                            ...
                            <div className="lp-grid">
                                ...
                                {/* 🚀 NEW MATRIC CERTIFICATE / FLC NUMBER FIELD */}
                    ...
                    {step === 3 && (
                        <div className="lp-form-body animate-fade-in">
                            ...
                            <div className="lp-actions"><button className="lp-btn-ghost" onClick={() => setStep(2)}>Back</button><button className="lp-btn-primary" onClick={handleSubmit} disabled={loading || !formData.popiaConsent || !formData.statssaAreaCode}>{loading ? 'Saving Compliance...' : 'Complete Profile'} <Save size={15} /></button></div>
                        </div>
                    )}
                </div>
            </div>
