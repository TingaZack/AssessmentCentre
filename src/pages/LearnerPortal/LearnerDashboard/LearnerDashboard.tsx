...
const LearnerDashboard: React.FC = () => {
    ...
    // 🚀 REAL-TIME PROFILE & ENROLLMENT LISTENER
    useEffect(() => {
        store.fetchCohorts();
        store.fetchStaff();
                    ...
                    <div className="admin-content">
                        {currentNav === 'dashboard' && (
                            <div className="ld-animate">
                                ...
                                {/* 🚀 NEW: ECOSYSTEM EVENTS TAB CONTENT */}
