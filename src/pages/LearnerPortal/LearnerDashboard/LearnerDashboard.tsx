...
import {
    ...
    Globe, MapPin, CheckCircle2, Target, Info, ClipboardList,
...
const LearnerDashboard: React.FC = () => {
    ...
    const [currentNav, setCurrentNav] = useState<'dashboard' | 'profile' | 'certificates' | 'attendance' | 'interviews'>(
    ...
    // 🚀 UPDATED ASSIGNED SURVEYS LOGIC
    const assignedSurveys = useMemo(() => {
        // Gather all raw cohort IDs attached to the learner, including "Unassigned"
        ...
        return allSurveys.filter(survey => {
            ...
            // Check if survey is meant for ALL, or if it explicitly matches their cohort (like "Unassigned")
    ...
    // SAFELY DERIVED SCORES & PAGE TITLES
    ...
    const pageTitle = currentNav === 'dashboard' ? 'My Dashboard' : currentNav === 'certificates' ? 'My Certificates' : currentNav === 'attendance' ? 'Compliance Hub' : currentNav === 'interviews' ? 'AI Mock Interviews' : 'My Profile';
    const pageSub = currentNav === 'dashboard' ? `Welcome back, ${store.user?.fullName || 'Learner'}` : currentNav === 'certificates' ? 'Official certificates issued to your profile' : currentNav === 'attendance' ? 'Track your compliance matrix and hardware log status' : currentNav === 'interviews' ? 'Practice real-time technical & behavioral interviews with AI' : 'Manage your personal details and account';
            ...
            <div className="admin-layout learner-layout">
                ...
                <main className="main-wrapper">
                    ...
                    <div className="admin-content">
                                ...
                                {showKPIs && (
                                    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(320px, 1fr))', gap: '1.25rem', marginBottom: '2rem' }} className="animate-slide-down">
                                        ...
                                        <ModuleProgressCard
                                            ...
                                            onClick={() => setCurrentNav('interviews')}
                                        />
                        ...
                        {/* VIEW 5: AI MOCK INTERVIEW STUDIO WORKSPACE */}
...
// //     // 🚀 UPDATED TYPE UNION TO INCLUDE 'interviews'
// //     const [currentNav, setCurrentNav] = useState<'dashboard' | 'profile' | 'certificates' | 'attendance' | 'interviews'>(
// //         (location.state as any)?.activeTab || 'dashboard'
// //     );
// //     const [activeDashTab, setActiveDashTab] = useState<'programmes' | 'tasks' | 'events' | 'surveys'>('programmes');
...
// //     // 🚀 SAFELY DERIVED EMPLOYABILITY SCORES FROM ACADEMIC PROFILE
// //     const latestInterviewScore = academicProfile?.employabilityScore ?? academicProfile?.latestInterviewScore ?? 0;
// //     const techScore = academicProfile?.technicalScore ?? 0;
// //     const behavioralScore = academicProfile?.behavioralScore ?? 0;
...
// //                                         {/* 🚀 EMPLOYABILITY SCORE CARD WITH SAFE DERIVED SCORES */}
// //                                         <ModuleProgressCard
// //                                             type="Employability Score"
// //                                             data={{
// //                                                 total: 100,
...
// //                         {/* VIEW 5: AI MOCK INTERVIEWS LANDING / PRACTICE WORKSPACE */}
// //                         {currentNav === 'interviews' && (
// //                             <div className="ld-animate">
// //                                 <div style={{ background: 'white', border: '1px solid var(--mlab-border)', padding: '2rem', marginBottom: '1.5rem' }}>
// //                                     <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '0.5rem' }}>
// //                                         <Video size={28} color="var(--mlab-blue)" />
// //                                         <h2 style={{ margin: 0, fontFamily: 'var(--font-heading)', color: MIDNIGHT, textTransform: 'uppercase' }}>AI Mock Interview Studio</h2>
// //                                     </div>
// //                                     <p style={{ color: 'var(--mlab-grey)', margin: '0 0 1.5rem 0', lineHeight: 1.6, maxWidth: '650px' }}>
// //                                         Practice dynamic technical and STAR behavioral interviews with our real-time AI interviewer. Receive an instant multi-dimensional Employability Index and actionable growth feedback.
// //                                     </p>
// //                                     <button
// //                                         className="mlab-btn mlab-btn--primary"
// //                                         style={{ padding: '10px 20px', fontSize: '0.9rem', fontWeight: 700, borderRadius: 0 }}
// //                                         onClick={() => navigate('/portal/interview/setup')}
// //                                     >
