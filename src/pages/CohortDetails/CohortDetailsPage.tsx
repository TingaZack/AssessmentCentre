        ...
        try {
            ...
            enrolledLearners.forEach(learner => {
                ...
                dataRows.push([
                    ...
                    // 🚀 THE FIX: EXPLICITLY READ FROM THE KEY VERIFIED IN CONSOLE
...
//                 // 🚀 RESOLVE DB KEYS ROBUSTLY (Checks official interface keys, falls back to short keys)
...
//                             formattedSorDate = `${dateParts[2]}${dateParts[1]}${dateParts[0]}`; // DD-MM-YYYY to YYYYMMDD
//                         }
//                     }
//                 }
...
//                     d.provinceCode || "",
//                     d.statsaaAreaCode || (d as any).statsaaAreaCode || "",
//                     d.popiActAgree === 'No' ? 'N' : 'Y',
//                     formattedPopiDate,
//                     formattedExpCompletion,

//                     // Using the resolved actual values
//                     actualSorStatus,
